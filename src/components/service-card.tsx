...
export function ServiceCard({ title, description, benefit }: ServiceCardProps) {
  return (
    <article className="group rounded-3xl border border-teal/12 bg-white p-6 shadow-[0_10px_30px_-20px_rgba(0,0,0,0.28)] transition-all duration-300 hover:-translate-y-1 hover:border-sunshine-yellow/35 hover:shadow-[0_16px_40px_-24px_rgba(12,125,150,0.45)]">
